 ...
 *
 * Les deux cartes ont une largeur fixe : sur un écran de 375 px, la somme
 * (cartes + flèche + écarts) doit rester sous la largeur utile (343 px),
 * sinon toute la page déborde et scrolle horizontalement.
 */
export default function BeforeAfter() {
  return (
    <div className="relative mx-auto flex w-full max-w-sm items-center justify-center gap-2 sm:gap-4" aria-hidden>
      {/* La note brute */}
      <div className="w-[7.5rem] shrink-0 -rotate-3 rounded-xl border border-line-2 bg-surface p-3.5 shadow-lift sm:w-36">
      ...
      <svg viewBox="0 0 40 24" className="h-5 w-8 shrink-0 text-ink sm:h-6 sm:w-10" fill="none" stroke="currentColor" strokeWidth="2.2">
        <path d="M2 12h32m0 0-7-7m7 7-7 7" strokeLinecap="round" strokeLinejoin="round" />
      </svg>

      {/* La fiche */}
      <div className="w-40 shrink-0 rotate-2 rounded-xl border border-line bg-surface p-2.5 shadow-lift sm:w-44" style={categoryStyle("agro")}>
